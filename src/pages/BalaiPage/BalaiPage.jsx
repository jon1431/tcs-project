                ...
                <header className="mb-8">
                    ...
                    <div className="relative pl-4 mt-4 border-l-2 border-orange-200">
                        <p className="text-gray-800 text-2xl font-bold leading-relaxed italic font-sans">
                            “ The Balai is the most public face of the complex. It projects outward, inviting the
                            community while maintaining a boundary. “
                        </p>
                    </div>
                </header>
                ...
                <section className="mt-4 mb-10 h-[60vh] flex flex-col h-1/2">
                    <div className="space-y-4 h-full">
                        <div className="bg-gray-300 rounded shadow-inner flex h-1/2 rounded-2xl shadow-2xl">
                            <img src={HumilityImg} className='h-full'/>
                            <div className='m-2'>
                                <p className='text-2xl font-bold'>The Threshold of Humility</p>
                                <p className='text-xl leading-9'>The low archway forces visitors into a humble posture by making them bow to enter,
                                    establishing respect for authority.
                                </p>
                            </div>
                        </div>
                        <div className="bg-gray-300 rounded shadow-inner flex h-1/2 rounded-2xl shadow-2xl">
                            <img src={CivicSpace} className='h-full'/>
                            <div className='m-2'>
                                <p className='text-2xl font-bold'>Multi-Functional Civic Space</p>
                                <p className='text-xl leading-9'>The design of the open, airy building facilitated transparent
                                    village governance and comfortable gatherings.
                                </p>
                            </div>
                        </div>
                    </div>
